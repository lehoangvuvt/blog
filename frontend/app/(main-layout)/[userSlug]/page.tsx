                ...
                <div className="mt-5 flex min-h-9 flex-wrap items-center gap-3">
                  {isCheckingOwner ? (
                    ...
                    <>
                      <Link
                        href="/new-article"
                        className={`inline-flex items-center gap-2 rounded-full px-5 py-2 text-sm font-medium transition ${hasBackgroundImage
                      ...
                      <button
                        ...
                        className={`inline-flex items-center gap-2 rounded-full border px-5 py-2 text-sm font-medium transition ${hasBackgroundImage
